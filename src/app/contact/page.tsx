  ...
  return (
    <div className="w-full bg-obsidian min-h-screen pt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16 mb-16 text-white text-center">
        ...
        <p className="font-mono text-base sm:text-lg text-gray-300 max-w-2xl w-full mx-auto">
          Currently taking on select projects for Q4 2026. Whether it's a
          completely new digital identity or an architectural UI rebuild, leave
          your transmission below or reach out directly.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 mt-12 font-mono text-xs sm:text-sm uppercase font-bold text-peri">
          <a
            href="mailto:hello@sazibalasingam.com"
            className="hover:text-mint transition-colors break-all"
          >
            hello@sazibalasingam.com
          </a>
